...
**Unreal Engine Model Context Protocol Server** - lets AI assistants drive the Unreal Editor through <!-- count:tools -->21<!-- /count --> category tools covering <!-- count:actions -->569+<!-- /count --> actions.
...
- **[Project Registry](project-registry.md)** - Cross-platform multi-project MCP config generation
